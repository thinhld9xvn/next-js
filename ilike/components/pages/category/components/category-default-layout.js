...
import StickyPosts from './default-layout/sticky-posts';
import OldPosts from './default-layout/old-posts';
import GlBanner from './gl-banner';

export default function CategoryDefaultLayout({loading = true, loadingBanner = true, bannersLists, stickyPostsList = null, oldPostsList = null}) {
